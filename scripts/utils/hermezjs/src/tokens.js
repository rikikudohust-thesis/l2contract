const { splitSignature, Interface } = require('ethers/lib/utils')
const { constants } = require('ethers')
const ethersConstants = constants
const ERC20ABI = require('./abis/ERC20ABI.js')
const { ContractNames, CONTRACT_ADDRESSES, APPROVE_AMOUNT } = require('./constants.js')
const { getContract } = require('./contracts.js')
const { SignerType, getSigner } = require('./signers.js')
