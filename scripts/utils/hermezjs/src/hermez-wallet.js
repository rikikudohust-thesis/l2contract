...
const { buildTransactionHashMessage } = require("./tx-utils.js");
const { hexToBuffer, getRandomBytes } = require("./utils.js");
const { getProvider } = require("./providers.js");
const { getHermezAddress, isHermezEthereumAddress, hexToBase64BJJ } = require("./addresses.js");
const {
  METAMASK_MESSAGE,
...
module.exports = { HermezWallet, createWalletFromEtherAccount, createWalletFromBjjPvtKey };
