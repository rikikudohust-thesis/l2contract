...
const coordinatorApi = require("./api");
...
/**
 * Sets an environment = require( a chain id or = require( a custom environment object
...
function setEnvironment(env) {
  ...
  if (typeof env === "number") {
    ...
    setContractAddress(
      ...
      PUBLIC_CONTRACT_ADDRESSES[env][constants.ContractNames.WithdrawalDelayer]
    );
  ...
  if (typeof env === "object") {
    if (env.contractAddresses) {
      ...
      if (
        ...
        setContractAddress(
          constants.ContractNames.WithdrawalDelayer,
          env.contractAddresses[constants.ContractNames.WithdrawalDelayer]
        );
      }
    }
