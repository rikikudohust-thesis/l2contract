...
const { LedgerSigner } = require("./signers/ledger-signer.js");
const { TrezorSigner } = require("./signers/trezor-signer.js");
...
const getSigner = (provider, signerData) => {
  ...
  switch (signerData.type) {
    ...
    case SignerType.TREZOR: {
      return TrezorSigner.connect(provider, {
...
module.exports =  { SignerType, getSigner };
